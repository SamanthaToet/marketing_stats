...
- If the PH assumption is violated for a certain variable, a **stratified cox model** makes sense. This model allows the shape of the underlying hazard to vary for the diff levels of the variable. 
